...
urlpatterns = [
    ...
    # Input Cougar ID URL
    path('inputCougarID/', views.inputCougarID, name='inputCougarID'),
    # Verify Cougar ID URL
    path('verifyCougarID/', views.verifyCougarID, name='verifyCougarID'),
    ...
    # view all historical approval
    path("historical_approval/", views.historical_approval, name="historical_approval"),
    # view specific historical approval
    path('view_historical_approval/', views.view_historical_approval, name='view_historical_approval'),
]