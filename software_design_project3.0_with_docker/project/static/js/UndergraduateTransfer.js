document.addEventListener("DOMContentLoaded", function () {
    ...
    .addEventListener("submit", async function (event) {
        ...
        try {
            await fetch("http://localhost:5002/set-user-session", {
                method: "POST",
            ...
            const response = await fetch("http://localhost:5002/update-latex", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
            ...
            if (response.ok) {
                ...
                setTimeout(() => {
                    window.location.href = "/approvalsystem/get_UndergraduateTransfer_pdf/";
